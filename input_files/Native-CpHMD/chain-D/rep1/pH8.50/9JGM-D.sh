...
mkdir -p /leonardo_scratch/large/userexternal/tfernand/Projects/Alx-ribo/A-Deprot/chain-D/09_CpH-restr/native/rep1/pH8.50/tfernand_CpHMD$$
 
echo "Job executed in DIR: /leonardo_scratch/large/userexternal/tfernand/Projects/Alx-ribo/A-Deprot/chain-D/09_CpH-restr/native/rep1/pH8.50/tfernand_CpHMD$$ " >> $SLURM_SUBMIT_DIR/9JGM-D_${j}.blockinfo
...
cd /leonardo_scratch/large/userexternal/tfernand/Projects/Alx-ribo/A-Deprot/chain-D/09_CpH-restr/native/rep1/pH8.50/tfernand_CpHMD$$
...
nice -n 19 bash /leonardo_scratch/large/userexternal/tfernand/Projects/Alx-ribo/A-Deprot/chain-D/09_CpH-restr/native/rep1/pH8.50/tfernand_CpHMD$$/CpHMD.sh 9JGM-D_${j}.pHmdp > 9JGM-D_${j}.err 2>&1 

# Copy files and return to shared directory
rsync -r /leonardo_scratch/large/userexternal/tfernand/Projects/Alx-ribo/A-Deprot/chain-D/09_CpH-restr/native/rep1/pH8.50/tfernand_CpHMD$$/9JGM-D_${j}* $SLURM_SUBMIT_DIR
if [ ! -f $SLURM_SUBMIT_DIR/9JGM-D.sites ] ; then
rsync ./9JGM-D.sites $SLURM_SUBMIT_DIR/
fi
if [ -f /leonardo_scratch/large/userexternal/tfernand/Projects/Alx-ribo/A-Deprot/chain-D/09_CpH-restr/native/rep1/pH8.50/tfernand_CpHMD$$/colvar ] && [ -f /leonardo_scratch/large/userexternal/tfernand/Projects/Alx-ribo/A-Deprot/chain-D/09_CpH-restr/native/rep1/pH8.50/tfernand_CpHMD$$/HILLS ] && [[ $plumedtype != "grid" ]]  ; then
rsync -r ./colvar $SLURM_SUBMIT_DIR
rsync -r ./HILLS $SLURM_SUBMIT_DIR
fi
#
if [ -f /leonardo_scratch/large/userexternal/tfernand/Projects/Alx-ribo/A-Deprot/chain-D/09_CpH-restr/native/rep1/pH8.50/tfernand_CpHMD$$/colvar ] && [[ $plumedtype == "grid" ]]  ; then
rsync -r ./colvar $SLURM_SUBMIT_DIR
...
if [ -f /leonardo_scratch/large/userexternal/tfernand/Projects/Alx-ribo/A-Deprot/chain-D/09_CpH-restr/native/rep1/pH8.50/tfernand_CpHMD$$/colvar ] && [[ $plumedtype == "static" ]]  ; then
    if [ -f /leonardo_scratch/large/userexternal/tfernand/Projects/Alx-ribo/A-Deprot/chain-D/09_CpH-restr/native/rep1/pH8.50/colvar ] ; then    
...
#
if [ -f /leonardo_scratch/large/userexternal/tfernand/Projects/Alx-ribo/A-Deprot/chain-D/09_CpH-restr/native/rep1/pH8.50/tfernand_CpHMD$$/colvar ] && [[ $plumedtype == "generic" ]]  ; then
rsync -r ./colvar $SLURM_SUBMIT_DIR
fi
...
cd $SLURM_SUBMIT_DIR
rm -rf /leonardo_scratch/large/userexternal/tfernand/Projects/Alx-ribo/A-Deprot/chain-D/09_CpH-restr/native/rep1/pH8.50/tfernand_CpHMD$$
gzip -9 9JGM-D_${j}.{err,log,tpr}
else
