...
mpirun -np $SLURM_NTASKS $grom mdrun -v -deffnm run_steered_ermsd -pin on -bonded gpu -pme gpu -nb gpu -ntomp $SLURM_CPUS_PER_TASK -npme 1 -tunepme -dlb auto -maxh 23.9 -plumed steered_${chain}_${rep}.dat >> run_SMD.out 2>> run_SMD.err
