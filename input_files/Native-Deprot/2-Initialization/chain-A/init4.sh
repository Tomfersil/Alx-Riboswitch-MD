...
mpirun -np $SLURM_NTASKS $grom mdrun -v -deffnm init4 -pin on -bonded gpu -pme gpu -nb gpu -ntomp $SLURM_CPUS_PER_TASK -npme 1 -tunepme -dlb auto -v >> init4.out 2>> init4.err
