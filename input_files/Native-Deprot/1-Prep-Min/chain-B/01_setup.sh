...
# Include inner-bound ions (pocket+others): 202,203,207 while 208 is Mn to be converted to Mg
mg=203
awk -v mg=$mg '!/^HETATM/ || !/MG/ || $6 == 203 || $6 == 207 {print $0}' ${pdbid}_fixed_${chain}_allmg.pdb > ${pdbid}_fixed_${chain}.pdb
...
sed -i '/ATOM   6745  P /d' ${pdbid}_fixed_${chain}.pdb
sed -i '/ATOM   6746  OP1 /d' ${pdbid}_fixed_${chain}.pdb
sed -i '/ATOM   6747  OP2 /d' ${pdbid}_fixed_${chain}.pdb
sed -i 's/MG    MG B/MG    MG A/g' ${pdbid}_fixed_${chain}.pdb
