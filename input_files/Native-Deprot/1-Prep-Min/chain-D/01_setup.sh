...
# Include inner-bound ions (pocket+others): 201,207 while 208 is Mn to be converted to Mg
mg=207
awk -v mg=$mg '!/^HETATM/ || !/MG/ || $6 == 201 || $6 == 207 {print $0}' ${pdbid}_fixed_${chain}_allmg.pdb > ${pdbid}_fixed_${chain}.pdb
...
sed -i '/ATOM   4497  P /d' ${pdbid}_fixed_${chain}.pdb
sed -i '/ATOM   4498  OP1 /d' ${pdbid}_fixed_${chain}.pdb
sed -i '/ATOM   4499  OP2 /d' ${pdbid}_fixed_${chain}.pdb
sed -i 's/MG    MG D/MG    MG A/g' ${pdbid}_fixed_${chain}.pdb
