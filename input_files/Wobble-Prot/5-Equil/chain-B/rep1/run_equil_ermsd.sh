...
#
#SBATCH --job-name=Equil_ermsd_9JGM     # The name of your job, you'll se it in squeue.
...
$grom grompp -f run_equil_ermsd.mdp -c $Dir/../run_steered_ermsd.gro -r $Dir/../run_steered_ermsd.gro -p $Dir/../../../01_box-min/${sys}.top -n $ndx -o run_equil_ermsd.tpr -nice 19 -maxwarn 100 >> ${sys}.out 2>> ${sys}.err
mpirun -np $SLURM_NTASKS $grom mdrun -v -deffnm run_equil_ermsd -pin on -bonded gpu -pme gpu -nb gpu -ntomp $SLURM_CPUS_PER_TASK -npme 1 -tunepme -dlb auto -maxh 23.9 -plumed equil_${chain}_P_${rep}.dat >> run_SMD.out 2>> run_SMD.err
