...
rep=1
extra_ps=250000  # 250000 ps = 250 ns
#
prev_tpr=run_MD_equil_extended2.tpr
new_tpr=run_MD_equil_extended3.tpr


$grom convert-tpr -s ${prev_tpr} -extend ${extra_ps} -o ${new_tpr}
mpirun -np $SLURM_NTASKS $grom mdrun -s ${new_tpr} -cpi run_MD_equil.cpt -deffnm run_MD_equil -pin on -bonded gpu -pme gpu -nb gpu -ntomp $SLURM_CPUS_PER_TASK -npme 1 -tunepme -dlb auto -maxh 23.9 >> run_MD_equil.out 2>> run_MD_equil.err
