...
#
#SBATCH --job-name=Steered_9JGM     # The name of your job, you'll se it in squeue.
...
$grom grompp -f run_steered_ermsd.mdp -c $Dir/../../03_MD/rep${rep}/run_MD.gro -r $Dir/../../03_MD/rep${rep}/run_MD.gro -p $Dir/../../01_box-min/${sys}.top -n $ndx -o run_steered_ermsd.tpr -nice 19 -maxwarn 100 >> ${sys}.out 2>> ${sys}.err
mpirun -np $SLURM_NTASKS $grom mdrun -v -deffnm run_steered_ermsd -pin on -bonded gpu -pme gpu -nb gpu -ntomp $SLURM_CPUS_PER_TASK -npme 1 -tunepme -dlb auto -maxh 23.9 -plumed steered_${chain}_P_${rep}.dat >> run_SMD.out 2>> run_SMD.err
