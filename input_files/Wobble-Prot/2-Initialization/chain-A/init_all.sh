...
cp $Dir/../01_box-min/posre_RNA_chain_A.itp $Dir/../01_box-min/${sys}_init1.itp
cp $Dir/../01_box-min/$sys.top $Dir/../01_box-min/${sys}_init1.top
sed -i "s/posre_RNA_chain_A.itp/${sys}_init1.itp/g" $Dir/../01_box-min/${sys}_init1.top
...
sed 's/1000  1000  1000/100  100  100/g' $Dir/../01_box-min/posre_RNA_chain_A.itp > $Dir/../01_box-min/${sys}_init2.itp
sed -i "s/posre_RNA_chain_A.itp/${sys}_init2.itp/g" $Dir/../01_box-min/${sys}_init2.top
...
sed 's/1000  1000  1000/10  10  10/g' $Dir/../01_box-min/posre_RNA_chain_A.itp > $Dir/../01_box-min/${sys}_init3.itp
sed -i "s/posre_RNA_chain_A.itp/${sys}_init3.itp/g" $Dir/../01_box-min/${sys}_init3.top
